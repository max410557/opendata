...
class OpenUp(Model):
    ...
    field_resource_description_g_value = TextField(null=True)
    field_resource_description_g_format = CharField(max_length=255, null=True)

    class Meta:
        database = test
        db_table = 'field_data_field_resource_description_g'